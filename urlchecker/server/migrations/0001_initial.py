...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('server_url', (
            ...
            ('last_time_checked', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
    ...
    models = {
        ...
        'server.url': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_time_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
